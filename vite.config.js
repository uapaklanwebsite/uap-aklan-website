  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        adminMembers: resolve(import.meta.dirname, 'admin/members.html'),
        adminOfficers: resolve(import.meta.dirname, 'admin/officers.html'),
        adminGallery: resolve(import.meta.dirname, 'admin/gallery.html'),
        adminActivities: resolve(import.meta.dirname, 'admin/activities.html'),
        adminHistory: resolve(import.meta.dirname, 'admin/history.html'),
      },
    },
  },
});
